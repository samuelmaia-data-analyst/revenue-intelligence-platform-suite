...
- Lógica de negócio compartilhada no monorepo: `packages/portfolio_analytics_shared/`
...
A cobertura deste módulo é medida sobre `src/churn_prediction`, que é o pacote canônico para evolução do projeto.
